...
function SideBar({ attributes, robot, setRobot, paths, setPaths, animationState, setAnimationState, obstacles, setObstacles, obstaclesExpanded, setObstaclesExpanded, modules, setModules, modulesExpanded, setModulesExpanded, addedModules, setAddedModules, abortControllers, pathsTotal, setPathsTotal, addNotification, boundaryRect, keepInRect, handleGenerateAllPaths, generateOnePath, setPathLoadingStates, pathLoadingStates }) {
  const fileInputRef = useRef();

  return (
    <div className="Side-bar">
      <PathManager attributes={attributes} paths={paths} setPaths={setPaths} setRobot={setRobot} setAnimationState={setAnimationState} obstacles={obstacles} robot={robot} abortControllers={abortControllers} pathsTotal={pathsTotal} setPathsTotal={setPathsTotal} modules={modules} setModules={setModules} addNotification={addNotification} boundaryRect={boundaryRect} keepInRect={keepInRect} handleGenerateAllPaths={handleGenerateAllPaths} generateOnePath={generateOnePath} setPathLoadingStates={setPathLoadingStates} pathLoadingStates={pathLoadingStates} />
